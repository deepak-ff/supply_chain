> ## Archived prototype
>
> This is **SCBTSS**, the original Flask prototype this repository grew from. It is preserved here
> unmodified for reference and is **not** part of the ChainWarden build — nothing in the Go
> platform imports it, and CI does not run it.
>
> Its core idea — learn a statistical baseline of normal behaviour, then score deviations as a
> 0–100 Dynamic Trust Score — was carried forward into ChainWarden as
> [`internal/trust`](../../internal/trust), the `cwctl trust` command and the dashboard's
> **Trust Score** page. See [docs/TRUST_SCORE.md](../../docs/TRUST_SCORE.md).
>
> To run the prototype standalone: `cd legacy/scbtss-prototype && pip install -r requirements.txt && python run.py`
